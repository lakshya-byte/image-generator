      ...
      >
        <div className="max-w-6xl mx-auto px-6 text-center space-y-10">
          ...
          <motion.div variants={itemVariant}>
            <button onClick={onClickHandler} className="inline-flex items-center px-6 py-3 bg-blue-500 text-white text-lg font-medium rounded-md shadow-md hover:bg-blue-600 transition">
              Generate Images
              <img
